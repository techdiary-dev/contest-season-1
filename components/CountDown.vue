...
.countdown {
  @apply bg-white py-4 shadow-md md:rounded-md flex space-x-3 lg:space-x-12 justify-center font-boshonto;

  &__box {
    @apply text-center w-16;
  }
  &__time {
    @apply text-fuchsia text-3xl lg:text-7xl;
  }
...
export default {
  data() {
    return {
      ...
      second: null,
      day: null,
      countDate: new Date("May 31, 2021 00:00:00").getTime()
    };
  },
  mounted() {
    setInterval(() => {
